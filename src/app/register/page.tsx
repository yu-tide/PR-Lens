      ...
      <div className="flex flex-1 items-center justify-center px-4">
        <div className="w-full max-w-sm">
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl shadow-slate-200/70">
            <h1 className="text-xl font-semibold tracking-tight text-slate-950">注册</h1>
            <p className="mt-1 text-sm text-slate-500">创建一个 PR Lens 账号</p>
